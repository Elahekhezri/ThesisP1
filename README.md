...
[power_simple_wa.csv](./data/power_simple_wa.csv) | Seshat variables related to Polity Power Concenteration index without metadata merged with West Asia subset of `polity_normal`.
